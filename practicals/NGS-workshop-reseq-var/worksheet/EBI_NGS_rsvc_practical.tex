...
\newcommand{\coursedate} {6th April 2017}
...
\note<1->[item]{
	Merge BAMs:\\
	\texttt{picard MergeSamFiles I=lane1/lane1.sorted.bam I=lane2/lane2.sorted.bam O=library.bam}
}
\end{frame}
...
\note<1->[item]{
	Mark Duplicates:\\
	\texttt{picard MarkDuplicates I=library.bam O=library.markdup.bam M=metrics.out}\\
